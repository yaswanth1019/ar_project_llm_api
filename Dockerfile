...
# Expose port (default 10000 if not set)
EXPOSE ${PORT:-10000}
...
CMD ["sh", "-c", "echo 'Starting on port $PORT' && python -m uvicorn main:app --host 0.0.0.0 --port ${PORT:-10000} --workers 1 --access-log --log-level info --timeout-keep-alive 30"]
